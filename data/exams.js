...
{id:'Commerce',label:'Commerce & Professional Courses',ico:'💹',color:'#0D6640',bg:'#E8F8EF',exams:[
  ...
  {name:'CSEET',full:'Company Secretary Executive Entrance Test',body:'ICSI',level:'Professional',freq:'Three times a year (Feb, Jun & Oct)',subjects:['PCM','PCM+CS','PCB','PCMB','Commerce','Arts','Any'],for:'Mandatory entry test after Class 12 for the CS Executive Programme — required for all categories of students, leading to CS Professional Programme and the Company Secretary (ACS) designation.',website:'icsi.edu',note:'Restructured from Jun 2026 into a 4-day, centre-based offline exam covering Business Communication, Fundamentals of Accounting, Economic & Business Environment, and Business Laws & Management. Replaced the earlier CS Foundation Programme, discontinued Feb 2020.',seats:'Open — no seat limit',institutes:[
